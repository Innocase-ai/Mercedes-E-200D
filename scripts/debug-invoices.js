                ...
                const created = await base(tableName).create([
                    {
                        fields: {
                            ...
                            'Date Analyse': '2023-01-01',
                            // 'Document': [] // Attachments usually need an array of objects with url, but we can't easily upload a file via API without a public URL. 
                            // We will test text fields first.
                        }
                    }
                ]);
